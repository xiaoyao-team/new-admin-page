<template>
  <div>
    <el-row :gutter="20" style="border-bottom:1px dashed #DCDFE6">
      <el-button size="small" type="primary" plain class="change_group_btn el-icon-edit" @click="editReward">修改礼包</el-button>
      <!-- left -->
      <el-col :span="10" style="border-right:1px dashed #DCDFE6;">
        <div class="grid-content bg-purple" >
          <el-form ref="rewardInfoForm" :rules="rewardInfoRules" :model="rewardInfoForm" label-width="100px">
            ...
            <section v-show="rewardInfoForm.giftPackageType == 3">
              ...
              <el-form-item label="邮件内容 :" prop="mailContentList">
                <el-input v-model="rewardInfoForm.mailContentList" style="width:95%;min-width:120px"></el-input>
              </el-form-item>
            </section>
      ...
      <el-col :span="14" >
        <div class="grid-content bg-purple">
          <el-form ref="groupForm2" :rules="rewardInfoRules" :model="rewardInfoForm" label-width="120px">
            <el-form-item label="礼包条件配置"></el-form-item>
          </el-form>
        </div>
      </el-col>
    </el-row> 
